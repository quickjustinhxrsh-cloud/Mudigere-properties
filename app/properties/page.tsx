    ...
    <main className="page-enter">
      ...
      <section className="section-pad">
        <div className="container-pad">
          <h1 className="text-4xl font-bold text-forest md:text-5xl">Our Properties</h1>
          <p style={{ fontFamily: "Montserrat", fontWeight: 500, fontSize: "32px", lineHeight: "100%", maxWidth: "100%", marginTop: "20px", color: "rgb(31, 31, 31)" }}>
